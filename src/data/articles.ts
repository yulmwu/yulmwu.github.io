...
export const articlesRaw: Article[] = [
    ...
    },
    {
        ...
        date: '2025-07-05',
        url: 'https://velog.io/@yulmwu/velog-backup-with-eventbridge',
        tags: ['AWS', 'Velog'],
        homePin: true,
    },
    {
    ...
    {
        thumbnail: 'https://velog.velcdn.com/images/yulmwu/post/a3bf11b8-cabf-40e9-a90b-24150705a29d/image.png',
        title: '[AWS] Deployment with EC2 + ECS Fargate + DocumentDB, ElastiCache Redis OSS',
        description: 'AWS MSA Deployment with EC2 + ECS Fargate and DocumentDB, ElastiCache(Redis OSS) Database',
        date: '2025-07-04',
        url: 'https://velog.io/@yulmwu/aws-deployment-with-ec2-ecs-and-documentdb-elasticache',
        tags: ['AWS'],
    },
    {
    ...
    {
        thumbnail: 'https://velog.velcdn.com/images/yulmwu/post/0b69c16b-7fe1-4204-89db-d44eebd6339b/image.png',
        title: '[NestJS] Using AWS S3 Presigned URL (POST)',
        description: 'Presigned URL with POST HTTP method and Their use in NestJS',
        date: '2025-08-06',
        url: 'https://velog.io/@yulmwu/nestjs-s3-presigned-url-post',
        tags: ['NestJS', 'AWS'],
    },
    {
        thumbnail: 'https://velog.velcdn.com/images/yulmwu/post/9d8d9ad4-a392-4db2-8bdc-3eba8ec0ca9e/image.png',
        title: '[AWS] Secrets Manager Key Rotation Lambda',
        description: 'AWS Secrets Manager Key Rotation with Lambda Function',
        date: '2025-08-12',
        url: 'https://velog.io/@yulmwu/aws-secrets-manager-key-rotation-lambda',
        tags: ['AWS'],
    },
]
