        ...
        <motion.div id='main' ref={ref} initial={{ opacity: 0 }} animate={inView ? { opacity: 1 } : {}} transition={{ duration: 1, delay: 0.3 }}>
            <div className='w-full h-screen top-0 left-0 bg-white/30'>
                <div className='m-auto h-full w-full flex flex-col justify-center lg:items-center items-center gap-2'>
                    <p className='text-4xl sm:text-5xl md:text-6xl font-bold text-gray-950 w-full text-center'>Kim Jun Young</p>
                    <p className='flex text-lg text-gray-950'>
                        <span className='text-2xl sm:text-3xl md:text-4xl text-[#212121] pt-[6px] pr-3'>반갑습니다</span>
                    ...
                    <div className='flex gap-4 pt-4'>
                        <a href='https://github.com/yulmwu' target='_blank'>
                            <FaGithub className='cursor-pointer w-[30px] h-[30px] sm:w-[35px] sm:h-[35px] md:w-[40px] md:h-[40px]' />
                        </a>
                        <a href='https://discord.com/users/615383266412724246' target='_blank'>
                            <FaDiscord className='cursor-pointer w-[30px] h-[30px] sm:w-[35px] sm:h-[35px] md:w-[40px] md:h-[40px]' />
                        </a>
                    </div>
                </div>
            </div>
