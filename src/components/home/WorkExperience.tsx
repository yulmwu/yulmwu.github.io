    ...
    <div className='rounded-2xl outline outline-gray-100 bg-white shadow-sm'>
        <div className='p-7 pb-1'>
            <div className='flex items-center mb-5'>
                ...
                <div className='text-sm text-gray-600 font-semibold pl-3'>경력</div>
            </div>
            <div className='space-y-3 mb-2'>
                {workExperience.map((item: WorkExperienceContent, index: number) => (
                    <div
                        key={index}
                        className='flex flex-col relative pb-6 cursor-pointer hover:bg-gray-50 transition-colors duration-200 rounded-lg p-3 -ml-3'
                    >
